...
let AccountsModule = AccountsModule_1 = class AccountsModule {
    static forRootAsync(elrondProxyOptions, proxyServiceOptions, apiConfigOptions, elrondApiOptions) {
        const providers = [
            {
        ...
        return {
            ...
            imports: [
                staking_1.StakingModule.forRootAsync(elrondProxyOptions, proxyServiceOptions, apiConfigOptions, elrondApiOptions),
