...
let StakingGetterService = StakingGetterService_1 = class StakingGetterService {
    constructor(abiService, elrondApiService, proxyService) {
    ...
    async getData(cacheKey, createValueFunc, _ttl = erdnest_1.Constants.oneHour()) {
        var _a, _b;
        try {
...
StakingGetterService = StakingGetterService_1 = tslib_1.__decorate([
    ...
    tslib_1.__param(1, (0, common_1.Inject)(constants_1.STAKEGOLD_ELROND_API_SERVICE)),
    tslib_1.__param(2, (0, common_1.Inject)(constants_1.STAKEGOLD_PROXY_SERVICE)),
    tslib_1.__metadata("design:paramtypes", [staking_abi_service_1.AbiStakingService, Object, Object])
