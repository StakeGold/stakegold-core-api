...
let AbiStakingService = AbiStakingService_1 = class AbiStakingService {
    ...
    async getVestingAddressByGroupIdentifier(groupId) {
        ...
        const response = await this.getGenericData(contract, interaction);
        console.log('getVestingAddressByGroupIdentifier', (_b = (_a = response.firstValue) === null || _a === void 0 ? void 0 : _a.valueOf()) === null || _b === void 0 ? void 0 : _b.toString());
        return (_d = (_c = response.firstValue) === null || _c === void 0 ? void 0 : _c.valueOf()) === null || _d === void 0 ? void 0 : _d.toString();
    }
    async getLockedAssetTokenId(vestingAddress) {
        ...
        const response = await this.getGenericData(contract, interaction);
        console.log('Marius', `getLockedAssetTokenId = ${(_b = (_a = response.firstValue) === null || _a === void 0 ? void 0 : _a.valueOf()) === null || _b === void 0 ? void 0 : _b.toString()}`);
        return (_d = (_c = response.firstValue) === null || _c === void 0 ? void 0 : _c.valueOf()) === null || _d === void 0 ? void 0 : _d.toString();
    }
