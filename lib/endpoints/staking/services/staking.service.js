...
let StakingService = class StakingService {
    ...
    async getFarms(address, vmQuery) {
        ...
        await Promise.all(farmStakingGroups.map(async (group) => {
            ...
            const farms = (_a = (await this.handleAddressesByGroupId(group, knownFarms, metaEsdtsDetails, vmQuery))) !== null && _a !== void 0 ? _a : [];
            groups.push({
    ...
    async handleAddressesByGroupId(farmStakingGroup, knownFarms, metaEsdtsDetails, vmQuery) {
